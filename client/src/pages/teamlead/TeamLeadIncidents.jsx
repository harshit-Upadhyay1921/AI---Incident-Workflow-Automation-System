            ...
            const dummy = {
                incidents: [
                    ...
                    },
                    {
                        ...
                        priority: "medium",
                        status: "open",
                        createdBy: { name: "Team Lead", email: "teamlead@example.com" },
                        assignedTo: { name: "Support Agent", email: "support@example.com" },
                        assignedDept: "IT",
    ...
    return (
        <div className="space-y-8 max-w-7xl mx-auto">
            ...
            >
                ...
                <p className="text-gray-600">View and manage all incidents in your organization</p>
            </motion.div>
...
export default TeamLeadIncidents;
